...
Camera camera; // Globale Kamera-Instanz
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "OpenGL Advanced Camera", NULL, NULL);
    if (window == NULL) {
    ...
    // Maus einfangen (wichtig für FREE Mode)
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // WICHTIG: ViewPos kommt jetzt von der Kamera
        phongShader.setVec3("viewPos", camera.getPosition());

        // Matrizen von der Kamera holen
